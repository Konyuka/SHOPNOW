                ...
                <div class="bg-white overflow-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">Client Name Used</th>
                                <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">Contact Phone</th>
                                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Order Time</th>
                                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Email Used</th>
                        ...
                        <tbody class="text-gray-700">
                            <tr v-for="order in orders" :key="order._id">
                                ...
                                <td class="w-1/3 text-left py-3 px-4">
                                    ...
                                    <inertia-link :href="route('client.order.view', order._id)">
