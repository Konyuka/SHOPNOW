<template>
<div class="py-20 background px-2">
    
    <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <h1 class="text-3xl font-semibold text-center text-gray-700 dark:text-white">Admin Registration</h1>

        <form class="mt-6">
            <div>
                <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">User Name</label>
            ...
            <div class="mt-4">
                <label for="username" class="block text-sm text-gray-800 dark:text-gray-200">Shop Name</label>
                <input type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-200 border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-200 border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="password" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-gray-200 border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <p class="text-xs text-center text-gray-500 uppercase dark:text-gray-400">or Register with google</p>
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> You have an account? 
            <inertia-link href="/login" class="font-medium text-gray-800 dark:text-gray-200 hover:underline">Login</inertia-link></p>
    </div>
</div>
</template>
