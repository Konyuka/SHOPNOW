...
<div class="py-20 background px-2">
    ...
    <div class="w-full max-w-sm p-6 m-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <p class="text-xs text-center text-gray-500 uppercase dark:text-gray-400">or Authenticate with google</p>
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account? 
            <inertia-link href="/register" class="font-medium text-gray-800 dark:text-gray-200 hover:underline">Create One</inertia-link></p>
    </div>
</div>
</template>
